...
haslist = True
haslink = True
title = "Promocao O Povo"
meta_type = "promocao_opovo"
...
class App(BaseApp, PortalUtils, Adm, Public):
    ...
    @dbconnectionapp
    def _install(self, title, tipo, captcha, 
    ...
    @serialize
    @Permission("ADM APP")
    def editApp(self, title, tipo, captcha, 
                       rss_titulo=None, rss_link=None, rss_descricao=None,
                       rss_idioma=None, rss_categoria=None, rss_copyright=None,
                       rss_imagem_titulo=None, rss_imagem_link=None,
                       rss_imagem=None):
    ...
    def _setDados(self, id_conteudo):
        ...
        for i in self.execSql("select_dados",
            ...
            dados = {"titulo":i["titulo"],
                     ...
                     "imagem_topo_list":i["imagem_topo_list"],
                     "imagem_rodape":i["imagem_rodape"],
                     "imagem_bg_topo":i["imagem_bg_topo"],
                     "imagem_bg_rodape":i["imagem_bg_rodape"],
                     "cor":i["cor"],
                     "cadastro_unico":i["cadastro_unico"],
                     "campos":[],
                     "cadastros":[],
                     "destaque":[],
                     "tags":tags}
            ...
            for j in self.execSql("select_conteudo_campos",
                                  id_conteudo=int(id_conteudo)):
                dados["campos"].append(j)
                
            for j in self.execSql("select_all_conteudo_cadastros",
                                  id_conteudo=int(id_conteudo)):
